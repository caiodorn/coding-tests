...
@SpringBootTest(classes = { GolfTournamentEntityMapperImpl.class, LocalDateTimeMapper.class })
class GolfTournamentEntityMapperITest {

    @Autowired
    GolfTournamentEntityMapper mapper;

    @Test
    void shouldMapAllFields_whenToEntity_givenTypeA() {
    ...
    @Test
    void shouldMapAllFields_whenToEntity_givenTypeB() {
        LocalDateTime startDate = LocalDateTime.of(2000, 1,1,0,0,0);
        LocalDateTime endDate = LocalDateTime.of(2001, 1,1,0,0,0);
